"""
Modified from https://github.com/allenai/allennlp/blob/v0.9.0/allennlp/data/dataset_readers/universal_dependencies_multilang.py
"""
...
@DatasetReader.register("universal_dependencies_multilang_empty_head")
class UniversalDependenciesMultiLangEmptyHeadDatasetReader(DatasetReader):
    """
